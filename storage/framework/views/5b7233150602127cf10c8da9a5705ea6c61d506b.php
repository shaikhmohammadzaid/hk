...
//==== Add Leave Type ===========
   ...
   $(document).on('click','#btn-save',function(e){
    e.preventDefault();
      ...
      $.post("<?php echo e(route('AddLeaveType')); ?>",{leave_type:leave_type},function(data){
  ...
  $(document).on('click','.edit',function(){
   ...
   $(document).on('click','#btn-update',function(){
      ...
      var leave_type=$('#edit_leave_type').val();
       ...
       jQuery.ajaxSetup({ headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') }  });
      $.post("<?php echo e(route('UpdateLeaveType')); ?>",{leave_id:leave_id,leave_type:leave_type},function(data){
              ...
              .then((willDelete) => {
               if (willDelete) 
               {
                 //sweet alert
                  ...
                  $.get("<?php echo e(route('deleteLeaveType')); ?>",{leave_id:leave_id,},function(data){
                      location.reload(true);
...
//==== Delete Leave Type ===========
  ...
  function showLeaveDetails(){
      var data = $('#frm-c').serialize();
        $.get("<?php echo e(route('showLeaveDetails')); ?>",data,function(data){
