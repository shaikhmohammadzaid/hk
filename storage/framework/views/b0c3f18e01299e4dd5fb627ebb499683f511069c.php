...
//==== Add Leave Type ===========
   ...
   $(document).on('click','#btn-save',function(e){
    e.preventDefault();
      ...
      $.post("<?php echo e(route('additems')); ?>",{leave_type:leave_type ,qua:qua },function(data){
  ...
  $(document).on('click','.allocate',function(){
   ...
   $(document).on('click','#btn-allocate',function(){
      ...
      var allocate_id=$('#allocate_id').val();
       ...
       jQuery.ajaxSetup({ headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') }  });
      $.post("<?php echo e(route('allocate')); ?>",{leave_id:leave_id,allocate_id:allocate_id,allocate_qun:allocate_qun},function(data){
  ...
  $(document).on('click','.qadd',function(){
   ...
   $(document).on('click','#btn-adddqun',function(){
      ...
      var leave_type=$('#add_item_name').val();
       ...
       jQuery.ajaxSetup({ headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') }  });
      $.post("<?php echo e(route('adqun')); ?>",{leave_id:leave_id,leave_type:leave_type,qun:qun},function(data){
  ...
  $(document).on('click','.edit',function(){
   ...
   $(document).on('click','#btn-update',function(){
      ...
      var leave_type=$('#edit_leave_type').val();
       ...
       jQuery.ajaxSetup({ headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') }  });
      $.post("<?php echo e(route('UpdateItem')); ?>",{leave_id:leave_id,leave_type:leave_type,qun:qun},function(data){
              ...
              .then((willDelete) => {
               if (willDelete) 
               {
                 //sweet alert
                  ...
                  $.get("<?php echo e(route('deleteitem')); ?>",{leave_id:leave_id,},function(data){
                      location.reload(true);
...
//==== Delete Leave Type ===========
  ...
  function showLeaveDetails(){
      var data = $('#frm-c').serialize();
        $.get("<?php echo e(route('showStoreDetails')); ?>",data,function(data){
