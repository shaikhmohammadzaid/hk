   ...
   $(document).on('click','#btn-save',function(e){
    e.preventDefault();
     ...
     var allocate_item=$('#allocate_item_name').val();
      ...
      $.post("{{ route('allocate') }}",{allocate_item:allocate_item ,allocate_id:allocate_id , allocate_qun:allocate_qun },function(data){
    ...
    e.preventDefault();
     ...
     var allocate_item=$('#return_item_name').val();
      var allocate_id=$('#return_id').val();
       ...
       jQuery.ajaxSetup({ headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') }  });
      $.post("{{ route('return') }}",{allocate_item:allocate_item ,allocate_id:allocate_id , allocate_qun:allocate_qun ,return_item_id:return_item_id , return_quntityy:return_quntityy },function(data){
...
//==== Delete Leave Type ===========
  ...
  function showLeaveDetails(){
      var data = $('#frm-c').serialize();
        $.get("{{ route('showDetails') }}",data,function(data){
