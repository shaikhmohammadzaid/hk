...
<div class="page-breadcrumb">
  <div class="row">
    <div class="col-5 align-self-center">
      <h4 class="page-title">Project Manager Leaves management</h4>
      <div class="d-flex align-items-center">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{url('admin/dashboard')}}">Home</a></li>
            <li class="breadcrumb-item"><a href="{{url('admin/dashboard')}}">Leaves management</a></li>
            <li class="breadcrumb-item active" aria-current="page">Project Manager Leaves </li>
          </ol>
        </nav>
      </div>
    </div>
...
<div class="container-fluid">
   <div class="row">
        <div class="col-12">
              <div class="card">
                    <div class="card-body">
                       <h4 class="card-title">Serch Project Manager Leave</h4>
  ...
  <div class="row">
    <div class="col-12">
      <div class="card">
        <div class="card-body">
          <h4 class="card-title">Project Manager Leaves </h4>
...
$(document).on('click','.btn-refresh',function(){
  ...
  function showDetails(){
      var data = $('#frm-c').serialize();
        $.get("{{ route('showAdminPmLeave') }}",data,function(data){
   ...
   $(document).on('submit','#frm-search',function(e){
    e.preventDefault();
     ...
     $.get("{{ route('searchAdminPmLeaves') }}",{leave_id:leave_id,status:status,start:start,end:end},function(data){
   ...
   $(document).on('click','.btn-leave',function(e){
       ...
       var status=$(this).data('status');
        ...
        $.get("{{ route('PmLeaveStatus') }}",{id:id,status:status},function(data){
