          ...
          <div class="row">
            <div class="col-md-3">
              <div class="panel-heading p-t-5 p-b-5" style="background-color: #ff0000" >
                <div class="panel-title">
                  <h6 class="text-white" style="text-align:center; padding-top:10px;"> To Do ({{task_todo(Auth::user()->id)}}) </h6>
                </div>
              </div>
            ...
            <div class="col-md-3">
              <div class="panel-heading p-t-5 p-b-5" style="background-color: #999F88" >
                <div class="panel-title">
                  <h6 class="text-white" style="text-align:center; padding-top:10px;"> Work in progress ({{task_working(Auth::user()->id)}})</h6>
                </div>
              </div>
            ...
            <div class="col-md-3">
              <div class="panel-heading p-t-5 p-b-5" style="background-color: #007E33" >
                <div class="panel-title">
                  <h6 class="text-white" style="text-align:center; padding-top:10px;"> Completed ({{task_complete(Auth::user()->id)}})</h6>
                </div>
              </div>
...
<script>
	jQuery('.start').click( function (e) { 
		...
		e.preventDefault();   
		var path="{{url ('/')}}/admin/emp_updt_taskstatus/"+emp_id+"/"+task_id+"/"+status;			
		 jQuery.ajax({
					  url:path,
					  method: 'GET', 
