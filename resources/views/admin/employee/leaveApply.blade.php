...
<div class="page-breadcrumb">
  <div class="row">
    <div class="col-5 align-self-center">
      <h4 class="page-title">Employee Leave Application</h4>
                    ...
                    <div class="col-12 ">
                        <div class="card">
                            ...
                            <form class="form-horizontal" id="frm-lm" method="post" >
                               {{ csrf_field() }}
                              <input type="hidden" class="form-control " name="emp_id" value="{{Auth::user()->id}}">
                                <div class="card-body">
 ...
 $(document).on('submit','#frm-lm',function(e){
   e.preventDefault();
     var data = $(this).serialize();
      ...
      $.post("{{ route('AddEmpLeave') }}",data,function(data){
