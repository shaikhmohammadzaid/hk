 <!-- ============================================================== -->
  <script src="{{ asset('public/admin/assets/libs/jquery/dist/jquery.min.js') }}"></script>
    ...
    <script src="{{ asset('public/admin/dist/min/jquery.inputmask.bundle.min.js') }}"></script>
     <script src="{{ asset('public/admin/dist/js/pages/forms/mask/mask.init.js') }}"></script>
    ...
    <!--c3 charts -->
    <script src="{{ asset('public/admin/assets/extra-libs/c3/d3.min.js') }}"></script>
    <script src="{{ asset('public/admin/assets/extra-libs/c3/c3.min.js') }}"></script>
    <!--chartjs -->
    <script src="{{ asset('public/admin/assets/libs/chart.js/dist/Chart.min.js') }}"></script>
    <script src="{{ asset('public/admin/dist/js/pages/dashboards/dashboard1.js') }}"></script>

<!--      // MAterial Date picker-->    

    <script src="{{ asset('public/admin/assets/libs/moment/moment.js') }}"></script>
    <script src="{{ asset('public/admin/assets/libs/bootstrap-material-datetimepicker/js/bootstrap-material-datetimepicker-custom.js') }}"></script>
